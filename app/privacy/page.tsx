  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-3xl">
      ...
      <div className="prose prose-slate">
        <p>At Connector Reviews, we prioritize your privacy. This policy outlines how we handle your data.</p>
        ...
        <h3>3. Contact</h3>
        <p>For inquiries, please contact business@imperialbohemia.com.</p>
      </div>
    </div>
  );
}
