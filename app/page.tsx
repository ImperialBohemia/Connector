...
export default async function Page() {
  ...
  if (!page) {
    // If no data exists at all, show a 404 or empty state
    return (
        <div className="flex flex-col items-center justify-center min-h-screen">
            <h1 className="text-2xl font-bold">System Initializing...</h1>
            <p>Please add a row to the Google Sheet or check credentials.</p>
        </div>
    );
  }
